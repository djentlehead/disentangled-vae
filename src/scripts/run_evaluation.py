...
if __name__ == '__main__':
    ...
    # Directory containing your original content files
    ORIGINALS_DIR = "path/to/original/bach/files"
    # Directory containing your style-transferred output files
    TRANSFERRED_DIR = "path/to/transferred/chopin/style/files"
    
    CLASSIFIER_CKPT_PATH = "checkpoints/style-classifier-best.ckpt"
    TARGET_STYLE_LABEL = 1 # e.g., 1 for Chopin in your STYLE_MAP
